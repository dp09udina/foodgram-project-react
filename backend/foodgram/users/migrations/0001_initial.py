# Generated by Django 3.2 on 2023-12-10 17:53
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('guest', 'guest'), ('user', 'user'), ('admin', 'admin')], default='user', max_length=25, verbose_name='Cтатус')),
                ...
                ('confirmation_code', models.CharField(blank=True, max_length=60, null=True, verbose_name='Код авторизациии')),
